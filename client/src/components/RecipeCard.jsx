    ...
    <div class="w-72 m-16 rounded-xl overflow-hidden shadow-lg bg-[#FFFFFF] justify-center content-center flex flex-col">
      ...
      <div className="flex flex-col p-2 pb-6 justify-center items-center">
        ...
        <div class="px-6 py-4 items-start">
          <h2 class="font-bold text-sm mb-2 text-[#04BF00]">Vegetarian</h2>
          <h2 class="font-bold text-sm mb-2 text-[#7E7E7E]">By Jacob Stanly</h2>
        </div>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold font-medium py-2 px-6 rounded-xl w-36">
          Full Recipe
        </button>
      </div>
    </div>
